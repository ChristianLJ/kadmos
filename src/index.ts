...
export default class Kadmos {
  ...
  private addPopupTemplateHtmlToDom(): void {
  ...
  public init(filePath: string, color: number, width: number, height: number): void {
    this.initScene();
  ...
  private getMesh(geometry: any, material: any): any {
